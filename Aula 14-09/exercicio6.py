...
tem  como  atributos,  além  dos  atributos  da classe Pessoa  e da  classe Empregado, o  atributo
valorProducao  (que corresponde  ao valor monetário dos artigos efetivamente produzidos pelo operário)
e comissao (que corresponde  ao valor que será adicionado  ao vencimento base  do operário -  não esqueça
que você pode utilizar o método original da classe Empregado como base...).

Você deverá  redefinir  nesta  subclasse  o método  herdado  calcularSalario  (o  salário  de  um
operário  é equivalente ao salário de  um  empregado usual  acrescido da  referida  comissão).
